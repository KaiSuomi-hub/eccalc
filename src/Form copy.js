...
class Form extends React.Component {
  constructor(props) {
    ...
    this.state = {
      a: 0, b: 0, c: 0, d: 0, e: 0, f: 0, g: 0, h: 0, i: 0, j: 0, k: 0, l: 0, m: 0, n: 0, o: 0, p: 0,
                  c2: 0, c3: 0, c4:0, c5:0, c6:0, c7:0, c8:0, c9:0, c10:0, c11:0, c12:0, c13:0, c14:0, c15:0};
  ...
  render() {
    const result = (((this.state.c * this.state.d) + (this.state.c2 * this.state.e) + (this.state.c3 * this.state.f) + (this.state.c4 * this.state.g) + (this.state.c5 * this.state.h)
      + (this.state.c6 * this.state.i) + (this.state.c7 * this.state.j) + (this.state.c8 * this.state.k) + (this.state.c9 * this.state.l) + (this.state.c10 * this.state.m)
      + (this.state.c11 * this.state.n) + (this.state.c12 * this.state.o) + (this.state.c13 * this.state.p) + (this.state.c14 * this.state.q) + (this.state.c15 * this.state.r)))
